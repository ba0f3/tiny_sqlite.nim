when not defined(SqliteStatic):
  ...
  {.pragma: sqlite, cdecl, dynlib: Lib.}
else:
  {.pragma: sqlite, cdecl.}
  {.compile: "private/sqlite3/sqlite3.c".}
